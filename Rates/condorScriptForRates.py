...
for infile in fileInputNames:
    ...
    tmp_job.write("\n")
    tmp_job.write("python handleFileTransfer.py -d %s -s %s"%(MYDIR, str(i)))
    tmp_job.close()
...
sub_total.write("#!/bin/sh\n")
sub_total.write("\n")
sub_total.write("rm -f Results/Raw/*/*.csv\n")
sub_total.write("rm -f Results/Raw/*/*.root\n")
sub_total.write("\n")
